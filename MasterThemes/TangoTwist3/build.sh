...
if [ ! -f "artisan" ]; then
    ...
    mkdir -p tempdown && cd tempdown && git clone https://github.com/ContatoLucasSonntag/Pterodactyl-Themes.git .
    cp -r MasterThemes/TangoTwist3/public ..
    cp -r MasterThemes/TangoTwist3/resources ..
